...
Color primary = const Color(0xD91130CE);

class Styles{
  static Color primaryColor = primary;
  static Color textColor = const Color(0xFF3b3b3b);
  static Color sectextColor = Colors.blue.shade500;
  static Color bgColor = const Color(0xFFeeedf2);
  static Color secbgColor = const Color(0xFFd2bdb6);
  static Color orangeColor = const Color(0xFFF37B67); 
  static Color secboxColor = const Color(0xFF526799);
